...
| **Текст** | Inter шести кеглей в трёх начертаниях, перенос по ширине с многоточием, выравнивание, разрядка, разноцветные куски внутри одной строки, свечение под буквами |
...
| Файл | Зачем |
|---|---|
| `config.yml` | откуда раздаётся пак, чувствительность курсора, звуки интерфейса |
