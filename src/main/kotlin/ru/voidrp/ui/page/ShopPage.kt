...
open class ShopPage : Page() {
    ...
    private val offers = listOf(
        ...
        Offer("crafting_table", "Crafting table", 8, "Four planks. The first thing anyone builds."),
        Offer("furnace", "Furnace", 16, "Eight cobblestone and a lot of patience."),
        Offer("tnt", "TNT", 140, "Faster than a pickaxe. Less precise."),
        Offer("oak_leaves", "Oak leaves", 4, "Shears, or they come apart in your hands."),
        Offer("grass_block", "Grass block", 6, "Silk Touch, or it is only dirt when you get it home."),
